...
/// and a function that implements a halo effect for multiple models.
extension Entity {
    /// The name of the 3D model resource file.
    static var fileName: String = "eggeye2"
    ...
    func addHalo() {
        ...
        for _ in 0..<modelCount {
            ...
            entity.setScale(SIMD3(repeating: 0.01 * .random(in: 0.5...2)), relativeTo: entity)
